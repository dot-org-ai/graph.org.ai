---
$id: https://textiles.manufacturing.org.ai
$context: https://textiles.manufacturing.org.ai
...
interface Textiles {
  '@context': 'https://textiles.manufacturing.org.ai'
  '@type': 'https://textiles.manufacturing.org.ai/Textiles'
  '@id': string
  name: string
  naicsCode?: string
  description?: string
...
interface TextileMills extends Textiles {
  '@type': 'https://textiles.manufacturing.org.ai/TextileMills'
}
...
interface TextileProducts extends Textiles {
  '@type': 'https://textiles.manufacturing.org.ai/TextileProducts'
}
...
interface Apparel extends Textiles {
  '@type': 'https://textiles.manufacturing.org.ai/Apparel'
}
...
interface TechnicalTextiles extends Textiles {
  '@type': 'https://textiles.manufacturing.org.ai/TechnicalTextiles'
}
...
interface SustainableTextiles extends Textiles {
  '@type': 'https://textiles.manufacturing.org.ai/SustainableTextiles'
}
...
interface TextileTech extends Textiles {
  '@type': 'https://textiles.manufacturing.org.ai/TextileTech'
}
```
